...
//        setFont(new Font("Verdana", Font.BOLD, 14)); // Set custom font
  ...
  public void jPanelLoader(JPanel parent, JPanel child) {
    ...
    private void initComponents() {
        ...
        emp_attend.add(search1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 20, -1, -1));

        search.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        search.setText("Enter Date:-");
        emp_attend.add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, -1, -1));
        ...
        emp_attend.add(search_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, 90, 35));
        ...
        emp_attend.add(emp_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, 240, 30));
        ...
        emp_attend.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 70, 240, 30));
