 ...
 */
public class Admin_Pass_Reset extends javax.swing.JFrame {

   Connection con = null;
   ResultSet rs = null;
   PreparedStatement ps = null;

    public Admin_Pass_Reset() {
        initComponents();
...
private int getPasswordStrength(String password) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 190, -1));

        jLabel7.setFont(new java.awt.Font("Rockwell Nova Extra Bold", 1, 26)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 102));
        jLabel7.setText("Admin Password Reset");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 80, 410, -1));
...
//        con = conn.mycon(); // Get the connection
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Pass_Reset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Pass_Reset().setVisible(true);
            }
        });
    }
