 ...
 */
public class Cutomer_sea extends javax.swing.JFrame {
   ...
   private void fetchEmployeeData() {
    try {
        ...
        String query = "SELECT ID, Name, Email, Username, Phone FROM customer_details";
   ...
   private void fetchEmployeeData(String searchQuery) {
    try {
        ...
        if (searchQuery == null || searchQuery.isEmpty()) {
            ...
            query = "SELECT * FROM customer_details WHERE ID LIKE ? OR Name LIKE ? OR Email LIKE ? OR Address LIKE ? OR Username LIKE ?OR Phone LIKE? ";
           pst = con.prepareStatement(query);
   ...
   private void customizeTable() {
    ...
    emp.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 14)); // Increase header font size
   ...
   class CustomTableCellRenderer extends DefaultTableCellRenderer {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, -1, 500));
  ...
  private void printTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cutomer_sea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cutomer_sea().setVisible(true);
            }
        });
    }
