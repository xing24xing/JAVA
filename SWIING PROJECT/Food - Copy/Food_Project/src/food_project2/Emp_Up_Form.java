...
//      add(emp_edu, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 460, 160, -1));
     ...
     add(emp_dob_calendar, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 440, 190, -1)); // Add JDateChooser
...
//      String DOJ = ((JTextField) emp_doj_calendar.getDateEditor().getUiComponent()).getText();
    ...
    private void initComponents() {
        ...
        add(emp_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 170, 240, 35));
