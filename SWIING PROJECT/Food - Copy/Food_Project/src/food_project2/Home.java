...
public class Home extends javax.swing.JFrame {
 JpanelLoader Jload = new JpanelLoader();
  ...
  PreparedStatement ps = null;
   private Enquiry enquiryPanel; // Assuming EnquiryPanel class exists
   ...
   // Hide all components of Home_Pane initially
     ...
     loadAndSetImage("E:\\Food\\adm.png", img1);
       loadAndSetImage("E:\\Food\\customer_logo.png", img2);
        ...
        // Add a change listener to Tab_nav to handle tab change events
        Tab_nav.addChangeListener(new javax.swing.event.ChangeListener() {
            @Override
...
private void loadEnquiryPanel() {
        if (enquiryPanel == null) {
           Enquiry rest = new Enquiry(child2,this);
    Jload.jPanelLoader(child2, rest);
        }
//        JpanelLoader(child2, enquiryPanel); // Load EnquiryPanel into child2
    }
...
private void admMouseClicked(java.awt.event.MouseEvent evt) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(product, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, 190, 50));
        ...
        jPanel1.add(employee, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 190, 50));
        ...
        jPanel1.add(rest_details, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 190, 50));
        ...
        jPanel1.add(Customer, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 470, 190, 50));
        ...
        jPanel1.add(Delivery1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 190, 50));
...
private void loadAndSetImage(String imagePath, JLabel label) {
    ...
    private void Delivery1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Delivery1ActionPerformed
       Delivery del = new Delivery(child2,this);
